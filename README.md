...
🌐 **演示地址：** [https://removed-munich-charms-lions.trycloudflare.com](https://removed-munich-charms-lions.trycloudflare.com)

- 用户端：`/` — 注册登录后即可使用
- 管理后台：`/admin/` — 食物库管理、用户管理、数据看板

> ⚠️ 演示地址依赖本地服务器，如无法访问请联系作者。
